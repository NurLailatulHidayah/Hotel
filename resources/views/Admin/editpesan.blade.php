<!-- Modal Edit Data -->
<div class="modal fade" id="modalEdit" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="modalTambahLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="/edit/{{$pesan->id}}" method="post" autocomplete="on">
          <div class="row mt-3">
          ...
          <div class="row">
            <div class="mb-3 col-12 col-md-6">
              <div><label for="jenis kelamin" class="form-label" name="jenis_kelamin" id="jenis_kelamin">Jenis Kelamin </label></div>
            ...
            <div class="mb-3 col-12 col-md-6">
              ...
              <input type="date" class="form-control form-control-sm" id="tgl_pesan" name="tgl_pesan" placeholder="">
            </div>
